  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <PageHeader
        ...
        description="Submit research papers, policy briefs, and field breakthroughs"
        actions={
      ...
      {showForm && (
        <Card>
          <CardHeader className="border-b border-[hsl(var(--border))]">
            <CardTitle>New Research Submission</CardTitle>
          </CardHeader>
          <CardContent className="pt-5">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <p className="text-[11px] text-[hsl(var(--text-4))] mt-1">Upload your document to ISB OneDrive and paste the share link here</p>
              </div>
      ...
      {loading ? (
        ...
        <EmptyState title="No research submissions" description="Create your first research submission to get started." />
      ) : (
